            ...
            <AnimatePresence mode="popLayout">
              ...
              `}
                        >
                            ...
                            {/* Icon */}
                            <span
                                className={`mr-2 flex-shrink-0 transition-colors ${isActive ? 'text-accent' : 'opacity-40 group-hover:opacity-100'}`}
                            >
                                {tab.protocol === 'SSH' ? (
                            ...
                            {/* Name */}
                            <span
                                className={`truncate flex-1 font-semibold tracking-tight ${isActive ? 'opacity-100' : 'opacity-70 group-hover:opacity-100'}`}
                            >
                                {tab.connectionName}
                            </span>
                ...
                `}
                                aria-label={`Close tab ${tab.connectionName}`}
                            >
