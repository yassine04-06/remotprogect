...
pub async fn traceroute(host: String, max_hops: Option<u32>) -> Result<Vec<TracerouteHop>, String> {
    ...
    tokio::task::spawn_blocking(move || {
        ...
        if hops.is_empty() {
            return Err("traceroute produced no parsable hops (tool missing or host unreachable)".into());
        }
        Ok(hops)
    })
    .await
...
const OUI_TABLE: &[(&str, &str)] = &[
    ...
    ("001C14", "VMware"), ("080027", "VirtualBox"), ("0A0027", "VirtualBox"),
    ("00155D", "Microsoft Hyper-V"), ("00037F", "Atheros"),
    ("001B21", "Intel"), ("001E67", "Intel"), ("3CFDFE", "Intel"),
    ("A0369F", "Intel"), ("001CC0", "Intel"), ("00A0C9", "Intel"),
    ("000D3A", "Microsoft"), ("0017FA", "Microsoft"), ("7C1E52", "Microsoft"),
    ("F01FAF", "Dell"), ("00188B", "Dell"), ("B8CA3A", "Dell"),
    ("00219B", "Dell"), ("001AA0", "Dell"), ("D067E5", "Dell"),
    ("001B78", "HP"), ("3C4A92", "HP"), ("9457A5", "HP"),
    ("00215A", "HP"), ("002264", "HP"), ("ECB1D7", "HP"),
    ("000142", "Cisco"), ("00000C", "Cisco"), ("001A2F", "Cisco"),
    ("0025B4", "Cisco"), ("F4CFE2", "Cisco"), ("00DEFB", "Cisco"),
    ("001D7E", "Cisco-Linksys"), ("002129", "Cisco-Linksys"),
    ("B827EB", "Raspberry Pi"), ("DCA632", "Raspberry Pi"),
    ("E45F01", "Raspberry Pi"), ("28CDC1", "Raspberry Pi"),
    ("001124", "Apple"), ("3C0754", "Apple"), ("A45E60", "Apple"),
    ("F0DBF8", "Apple"), ("ACBC32", "Apple"), ("DC2B2A", "Apple"),
    ("000FB5", "Netgear"), ("001E2A", "Netgear"), ("A040A0", "Netgear"),
    ("00146C", "Netgear"), ("00226B", "Netgear"),
    ("0018E7", "TP-Link"), ("50C7BF", "TP-Link"), ("D8150D", "TP-Link"),
    ("00904C", "Epson"), ("001B38", "Epson"),
    ("FCFBFB", "Ubiquiti"), ("0418D6", "Ubiquiti"), ("788A20", "Ubiquiti"),
    ("245A4C", "Ubiquiti"), ("E063DA", "Ubiquiti"),
    ("0050BA", "D-Link"), ("00179A", "D-Link"), ("1CBDB9", "D-Link"),
    ("002710", "Synology"), ("0011D8", "Asus"), ("1C872C", "Asus"),
    ("2C56DC", "Asus"), ("AC220B", "Asus"),
    ("525400", "QEMU/KVM"), ("FA163E", "OpenStack KVM"),
    ("00163E", "Xen"), ("001967", "Lenovo"), ("8CDCD4", "Lenovo"),
    ("48BA4E", "Lenovo"), ("00219E", "Sony"), ("000AE6", "Elitegroup"),
];
